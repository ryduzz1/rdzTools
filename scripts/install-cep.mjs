...
const sourceDir = path.join(root, "dist", "rdzTools");
...
const targetDir = path.join(extensionsDir, "rdzTools");
...
async function main() {
  ...
  console.log("Restart After Effects, then open Window > Extensions > rdzTools.");
}
